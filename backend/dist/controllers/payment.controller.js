...
exports.downloadInvoice = exports.processMockCardPayment = exports.recordManualPayment = exports.getPayments = void 0;
...
const recordManualPayment = async (req, res) => {
    try {
        ...
        if (!method || !Object.values(client_1.PaymentMethod).includes(method)) {
...
const processMockCardPayment = async (req, res) => {
    try {
        const { id } = req.params;
...
exports.processMockCardPayment = processMockCardPayment;
