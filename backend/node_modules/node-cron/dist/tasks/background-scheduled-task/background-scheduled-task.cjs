...
class BackgroundScheduledTask {
    ...
    getNextRun() {
        if (this.stateMachine.state !== 'stopped') {
            const timeMatcher$1 = new timeMatcher.TimeMatcher(this.cronExpression, this.options?.timezone);
            return timeMatcher$1.getNextMatch(new Date());
        }
        return null;
    }
    start() {
